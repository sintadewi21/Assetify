            ...
            <div class="card rounded-card border-0 bg-body shadow-sm p-4 p-md-5">
                ...
                <form action="{{ route('categories.store') }}" method="POST" class="d-flex flex-column gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required class="form-control py-2.5 rounded-3 @error('name') is-invalid @enderror" placeholder="e.g., Electronics, Office Supplies, Furniture">
                        @error('name')
                    ...
                    <div class="pt-4 border-top d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-telkomsel py-2.5 px-4 shadow rounded-3">
                            Save Category <i class="bi bi-check-circle ms-1"></i>
                        </button>
                    </div>
                </form>
